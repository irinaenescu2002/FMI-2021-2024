...
// Operatori care se scriu doar in clase membre (NU SE POT SUPRAINCARCA CU FUNCTII PRIETEN)
// =
// []
// () cu sensul de apel de functie
// ->
// Operatorii += si -= se pot face friend, dar la parametru trebuie sa avem referinta &
